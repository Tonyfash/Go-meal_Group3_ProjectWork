  ...
  try {
    ...
    const kitchens = await Kitchen.create([
      ...
      },
      {
        ...
        description: "Renee’s Kitchen is a bright, contemporary breakfast brand that specializes in quick, wholesome meals designed for people on the go. Founded by Chef Renee Okoro, the kitchen started as a small home project and has grown into a trusted name for innovative morning dishes"
      },
      {
        ...
        description: "Mama Kitchen is your go-to destination for hearty, home-style breakfasts inspired by Nigeria’s most loved family recipes. What began as a neighborhood food stand has grown into a trusted breakfast hub for professionals and remote workers alike"
      },
      {
        kitchenName: "Kayliz's Kitchen",
        kitchenLogo: "https://res.cloudinary.com/dmqhseusw/image/upload/v1759323998/IMG_0424_bbn40x.webp",
        description: "Kayliz’s Kitchen is a vibrant Go-Meal partner specializing in fresh, health-forward breakfasts that don’t compromise on taste. Founded by wellness enthusiast Kayla Izu, the kitchen started with a mission to give busy professionals and remote workers cleaner, smarter morning meals"
      },
    ]);
